...
def ad_resetpassword():
    ...
    canvas = Canvas(ad_root_resetpassword, borderwidth=0)
    scrollbar = Scrollbar(ad_root_resetpassword, orient=VERTICAL, command=canvas.yview)
    ...
    ad_label = Label(ad_root_resetpassword, text="   Cấp lại mật khẩu", fg="#34495E", font=("Arial", 16, "bold"),
                     borderwidth=0, relief=RAISED, width=81, height=2, anchor='w', bg="#DEE3EB")
    ad_label.place(x=292, y=0)

    ad_label_find = Label(ad_root_resetpassword, text="Tra cứu", font=("Arial", 14, "bold"),
                          fg="black", borderwidth=0)
    ad_label_find.place(x=310, y=80)

    ad_frame_find = Frame(ad_root_resetpassword, width=1015, height=200, borderwidth=2, relief=RAISED)
    ad_frame_find.place(x=310, y=110)

    ad_label_find_date = Label(ad_root_resetpassword, text="Ngày: ", font=("Arial", 12, "bold"),
                               fg="black", borderwidth=0)
    ad_label_find_date.place(x=350, y=140)

    ad_text_find_date = DateEntry(ad_root_resetpassword, width=20, height=2)
    ad_text_find_date.place(x=520, y=140)

    ad_label_find_moment = Label(ad_root_resetpassword, text="Thời điểm: ", font=("Arial", 12, "bold"),
                                 fg="black", borderwidth=0)
    ad_label_find_moment.place(x=850, y=140)

    # Tạo Spinbox cho giờ, phút, giây
    hour_spinbox = Spinbox(ad_root_resetpassword, from_=0, to=23, wrap=True, width=2, format="%02.0f")
    minute_spinbox = Spinbox(ad_root_resetpassword, from_=0, to=59, wrap=True, width=2, format="%02.0f")
    second_spinbox = Spinbox(ad_root_resetpassword, from_=0, to=59, wrap=True, width=2, format="%02.0f")
    ...
    Label(ad_root_resetpassword, text="Giờ", font=("Arial", 11, "bold")).place(x=1030, y=137)
    Label(ad_root_resetpassword, text="Phút", font=("Arial", 11, "bold")).place(x=1110, y=137)
    Label(ad_root_resetpassword, text="Giây", font=("Arial", 11, "bold")).place(x=1200, y=137)

    ad_label_user = Label(ad_root_resetpassword, text="Đối tượng sử dụng: ", font=("Arial", 12, "bold"),
                          fg="black", borderwidth=0)
    ...
    ad_combobox_find_user = Combobox(ad_root_resetpassword,
    ...
    ad_label_find_student = Label(ad_root_resetpassword, text="MSSV / Họ và tên: ", font=("Arial", 12, "bold"),
                                  fg="black", borderwidth=0)
    ...
    ad_button_delete_all = Button(ad_root_resetpassword, text="Bỏ chọn tất cả", font=("Arial", 12, "bold"), fg="white",
                                  bg="#34495E", command=delete_all)
    ad_button_delete_all.place(x=1200, y=350)

    ad_button_delete_account = Button(ad_root_resetpassword, text="Cấp lại mật khẩu", font=("Arial", 12, "bold"),
                                      fg="white",
                                      bg="#34495E", command=show_selected)
    ad_button_delete_account.place(x=1184, y=700)

    ad_root_resetpassword.mainloop()
