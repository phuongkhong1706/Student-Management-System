...
def ad_deleteaccount():
    ...
    ad_label = Label(User.ad_root_homepage, text="   Xóa tài khoản", fg="#34495E", font=("Arial", 16, "bold"),
    ...
    ad_label_list_create = Label(User.ad_root_homepage, text="Danh sách người dùng cần xóa tài khoản",
                                 font=("Arial", 14, "bold"),
                                 fg="black", borderwidth=0)
    ...
    tree_scroll = Scrollbar(User.ad_root_homepage, orient="vertical", command=tree.yview)
    ...
    def show_selected():
        ...
        for str in selected_accounts:
            History.save_user(User.user_input, f"Xóa TK cho mã TK {str}")
    ...
    ad_button_delete_account = Button(User.ad_root_homepage, text="Xóa tài khoản", font=("Arial", 12, "bold"),
                                      fg="white",
